...
namespace TelemarketingControlSystem.Migrations
{
    ...
    [Migration("20241015103516_AddMistakeTypeTables")]
    partial class AddMistakeTypeTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TelemarketingControlSystem.Models.MistakeReport", b =>
                {
                    ...
                    b.Property<string>("MistakeTypeName")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TelemarketingControlSystem.Models.MistakeReport", b =>
                {
                    b.HasOne("TelemarketingControlSystem.Models.Employee", "Employee")
                        .WithMany("MistakeReports")
                        .HasForeignKey("EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TelemarketingControlSystem.Models.MistakeType", "MistakeType")
                        .WithMany("MistakeReports")
                        .HasForeignKey("MistakeTypeName");
            ...
            modelBuilder.Entity("TelemarketingControlSystem.Models.ProjectMistakeDictionary", b =>
                {
                    b.HasOne("TelemarketingControlSystem.Models.Project", "Project")
                        .WithMany("ProjectMistakeDictionaries")
                        .HasForeignKey("ProjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TelemarketingControlSystem.Models.ProjectTypeDictionary", b =>
                {
                    b.HasOne("TelemarketingControlSystem.Models.ProjectType", "ProjectType")
                        .WithMany("ProjectTypeDictionaries")
                        .HasForeignKey("ProjectTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TelemarketingControlSystem.Models.Project", b =>
                {
                    ...
                    b.Navigation("ProjectMistakeDictionaries");
                });
