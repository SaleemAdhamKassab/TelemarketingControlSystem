...
namespace TelemarketingControlSystem.Services.ProjectStatistics
{
    ...
    public class ProjectStatisticsService(ApplicationDbContext db) : IProjectStatisticsService
    {
        ...
        private IQueryable<ProjectDetailCall> getProjectDetailCallsData(HourlyTargetDto hourlyTargetDto)
        {
            ...
            var minDuration = query.Select(e => e.DurationInSeconds).Min();
            query = query.Where(e => e.DurationInSeconds >= minDuration && e.DurationInSeconds <= minDuration + 120);
            return query;
        }
        ...
        public ResultWithMessage hourlyTarget(HourlyTargetDto hourlyTargetDto)
        {
            ...
            var totalMinutes = query.Select(e => e.DurationInSeconds).Sum() / 60.0;
